"""The script creates a unified Chukchi + Beaufort dataset for cases
   where one region has data from a multiple rasters, but the other region
   does not have any data. The output is merged raster using the maximum of the data
   and the mask from the region without data.
   This is considered Case C: many raster, single region."""
